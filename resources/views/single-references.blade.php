...
@section('content')
  @while(have_posts()) @php(the_post())
    ...
    <section class='contenu-prestation references'>
      ...
      <?php $img = get_sub_field('picto');?>
        ...
        <div class="row aling-middle <?php if($i%2!=0){ echo 'reverse';} ?>">
          ...
          <div class='small-12 medium-5 large-6 contenu-prestation__image flex-container align-middle align-center'>
            <img class='style-svg' src="<?=$img['url']?>"/>
          </div>

          <div class='small-12 medium-7 large-6 contenu-prestation__texte'>
