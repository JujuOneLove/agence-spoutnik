  ...
  <div class="reference_container">
    ...
    <ul class='references_works row expanded'>
        ...
        <?php
            ...
            $o = '<li class="entry large-3 medium-6 small-12 columns '.$x.'" style="background-image:url('.$entryimg[0].');">
            <div class="container_title"><h3><a href="'.get_permalink().'">'.get_the_title().'</a></h3></div>
            </li>';
